...
import  {type Note, type Tag}  from "../App";
...
export function NoteList({availableTags, notes, onUpdateTag, onDeleteTag}: NoteListProp){
    ...
    return (
        ...
        <EditTagsModal onDeleteTag={onDeleteTag} onUpdateTag={onUpdateTag} show={editTagsModalIsOpen} availableTags={availableTags} handleClose={() => setEditTagsModalIsOpen(false)} />
        </>
    )
}
